...
import cn.self.client.IndexDataClient;
...
public class BackTestService {
    ...
    public List<IndexData> listIndexData(String code) {
        List<IndexData> dataList = indexDataClient.getIndexData(code);
        CollectionUtil.reverse(dataList);
